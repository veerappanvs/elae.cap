...
public class ImportedCapListController {
	 ...
	 */
	@RequestMapping
	public String loadCapInfo(@RequestParam(value="year",required=false) String year, Model model) throws Exception {
	...
	List<ImportedCapInfo> importedCapInfos=	batchManager.getImportedCapReport(orgCode,year);
