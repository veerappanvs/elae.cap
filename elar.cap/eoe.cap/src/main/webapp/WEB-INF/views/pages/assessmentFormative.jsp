	...
	<jsp:include page="cycleInfo.jsp"></jsp:include>
		...
		<div class="form-group row">
			...
			<div class="col-sm-4" style="text-align: right">
				<label class="col-form-label">Require additional (Fifth)
					observation?</label>
			</div>
			<div class="col-sm-2">
		...
		<c:if test="${assessmentInfo.canSignOff }">
			<div class="form-group row">
				...
				<div class="col-sm-2">
					...
					<label class="col-form-label font-weight-bold">Complete</label>
				</div>
				<div class="col-sm-5"></div>
			</div>
			...
			<c:if test="${assessmentInfo.psApproved eq 'Y' }">
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<label class="col-form-label">The Program Supervisor has
							marked this Formative Assessment as "Finished".</label>
					</div>
					<div class="col-sm-4"></div>
				</div>
			...
			<div class="form-group row">
				<div class="col-sm-1"></div>
				<div class="col-sm-10">
					<label class="col-form-label"><b>Note:</b> Please check this box if this
