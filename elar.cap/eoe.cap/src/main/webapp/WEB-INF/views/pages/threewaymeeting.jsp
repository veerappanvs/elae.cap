...
<body>
	<form:form id="form2" method="POST" commandName="threewayMeeting">
		...
		<div class="form-group row">
			...
			<div class="col-sm-2">
				<form:input path="meetingDate1" cssClass="form-control" placeholder="mm/dd/yyyy" aria-label="First Three-Way Meeting"/>				
			</div>
		...
		<div class="form-group row">
			<div class="col-sm-12" style="text-align:center" >
				<div >
					<input type="submit" value="Save" class="btn btn-primary"  onclick="formSubmit(1)" /> 
				</div>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-2">
				<form:input path="meetingDate2" cssClass="form-control"  placeholder="mm/dd/yyyy" aria-label="Second Three-Way Meeting" />
			</div>
			<div class="col-sm-4"></div>
			<div class="col-sm-1"></div>
		</div>
		...
		<div class="form-group row">
			<div class="col-sm-12" style="text-align:center" >
				<div >
					<input type="submit" value="Save" class="btn btn-primary"  onclick="formSubmit(2)" /> 
				</div>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-2">
				<form:input path="meetingDate3" cssClass="form-control"  placeholder="mm/dd/yyyy" aria-label="Third Three-Way Meeting" />
			</div>
			<div class="col-sm-4"></div>
			<div class="col-sm-1"></div>
		</div>
		...
		<div class="form-group row">
			<div class="col-sm-12" style="text-align:center" >
				<div >
					<input type="submit" value="Save" class="btn btn-primary"  onclick="formSubmit(3)" /> 
				</div>
			</div>
		</div>
