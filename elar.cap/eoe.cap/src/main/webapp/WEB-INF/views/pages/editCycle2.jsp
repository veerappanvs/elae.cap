...
<body>
	<form:form id="form2" method="POST" commandName="capCycleInfo"  action="/cap/cycle" >
		...
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<label class="col-form-label">${capCycleInfo.programName}</label>
			</div>
		...
		<div class="form-group row">
			<div class="col-sm-1"></div>
			<div class="col-sm-2">
				<label class="col-form-label float-right font-weight-bold">Teacher Candidate
					MEPID:</label>
			</div>
			<div class="col-sm-2">
				<label class="col-form-label">${capCycleInfo.candidateMEPID}</label>
			</div>
			<div class="col-sm-3">
				<label class="col-form-label float-right font-weight-bold">Supervising
					Practitioner MEPID:</label>
			</div>
			<div class="col-sm-3">
				<label id="practionerMEPID"  class="col-form-label">${capCycleInfo.practitioner.mepid}</label>
		...
		<div class="form-group row">
			<div class="col-sm-5">
				<label class="col-form-label float-right font-weight-bold">Have any of the
					components of the approved programs been waived? </label>
			</div>
			<div class="col-sm-3">
		...
		<div class="form-group row">
			<div class="col-sm-1"></div>
			<div class="col-sm-2">
				<label class="col-form-label float-right font-weight-bold">Practium
					Information:</label>
			</div>
			<div class="col-sm-3">
			...
			<div class="col-sm-2">
				<label class="col-form-label float-right font-weight-bold">School Year:</label>
			</div>
			<div class="col-sm-3">
		...
		<div class="form-group row">
			<div class="col-sm-1"></div>
			<div class="col-sm-2">
				<label class="col-form-label float-right font-weight-bold">Program Area and
					Grad Level:</label>
			</div>
			<div class="col-sm-3">
				<label class="col-form-label"><form:input class="form-control " path="programAreaGradLevel"/></label>
			</div>
			<div class="col-sm-6"></div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<label id="practionerDistrict" class="col-form-label">${capCycleInfo.practitioner.districtName}</label>
			</div>
			<div class="col-sm-2">
				<label class="col-form-label float-right font-weight-bold">Practicum School:</label>
			</div>
			<div class="col-sm-3">
				<label id="practionerSchool"  class="col-form-label">${capCycleInfo.practitioner.schoolName}</label>
			</div>
			<div class="col-sm-1"></div>
		</div>
		...
		<div class="form-group row">
			<div class="col-sm-3">
				<label class="col-form-label float-right font-weight-bold">Practicum/Equivalent
					Seminar Course Title:</label>
			</div>
		...
		<div class="form-group row">
			<div class="col-sm-3">
				<label class="col-form-label float-right font-weight-bold">Grad level Of
					Practicum Students:</label>
			</div>
			<div class="col-sm-2"><form:input class="form-control" path="gradLevel"/></div>
			<div class="col-sm-3">
				<label class="col-form-label float-right font-weight-bold">Total Number of
					Practicum Hours:</label>
			</div>
		...
		<div class="form-group row">
			<div class="col-sm-3">
				<label class="col-form-label float-right font-weight-bold">Number of Hours
					assumed full responsibility in the role:</label>
			</div>
			<div class="col-sm-2"><form:input class="form-control" path="hoursFullResponsibility"/></div>
			<div class="col-sm-3">
				<label class="col-form-label float-right font-weight-bold">Credit Hours:</label>
			</div>
