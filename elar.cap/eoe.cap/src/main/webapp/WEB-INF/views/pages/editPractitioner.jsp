...
<form:form id="practitionerForm" method="POST"
	...
	<c:if test="${!(showResult or loadPractitionerInfo)}">
		...
		<div id="outOfStateSection"
			...
			<div class="form-group row">
				<div class="col-sm-3">
					<label class="col-form-label float-right font-weight-bold">First
						Name*:</label>
				</div>
				<div class="col-sm-3">
				...
				<div class="col-sm-3">
					<label class="col-form-label float-right font-weight-bold">Last
						Name*:</label>
				</div>
				<div class="col-sm-3">
	...
	<c:if test="${loadPractitionerInfo}">
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<label class="col-form-label">${capCycleInfo.practitioner.firstName} ${capCycleInfo.practitioner.lastName}</label>
			</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<label class="col-form-label">${capCycleInfo.practitioner.districtName}</label>
			</div>
			<div class="col-sm-3"></div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<label class="col-form-label">${capCycleInfo.practitioner.schoolName}</label>
			</div>
			<div class="col-sm-3"></div>
		</div>
		...
		<c:if test="${capCycleInfo.practitioner.daPersonId!=null}">
			<div class="form-group row">
				<div class="col-sm-3"></div>
				<div class="col-sm-3">
					<label class="col-form-label float-right font-weight-bold">Email:</label>
				</div>
				<div class="col-sm-3">
		...
		<div class="form-group row">
			...
			<div class="form-group row">
				<div class="col-sm-3"></div>
				<div class="col-sm-3">
					<label class="col-form-label float-right font-weight-bold">Confirm Email:</label>
				</div>
				<div class="col-sm-3">
