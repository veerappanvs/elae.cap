	...
	<form:form id="form2" method="POST" commandName="candidateEnrollment">
		...
		<div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<label id="supervisorName" class="col-form-label">${candidateEnrollment.supervisorName}</label>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<label class="col-form-label"><fmt:formatDate
							pattern="MM/dd/yyyy"
							value="${candidateEnrollment.cycleStartDate}" /></label>
				</div>
		...
		<div>
			...
			<div id="notes" class="form-group row">
				...
				<div class="col-sm-8">
					<span style="font-size: 1rem;"><b>Note:</b> Search for the
						Supervising Practitioner by selecting his/her Organization Type
						and District and entering his/her MEPID.</br> For Supervising
						Practitioners working outside of Massachusetts public schools, you
						will be prompted to enter his or her information manually.</span>
					<p>&nbsp</p>
				</div>
				<div class="col-sm-2"></div>
			</div>
