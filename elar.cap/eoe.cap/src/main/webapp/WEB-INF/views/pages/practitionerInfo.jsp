		...
		<div id="practitionerInfo">
			...
			<c:if
				...
				<div class="form-group row">
					...
					<div class="col-sm-3">
						<label class="col-form-label">${supervisorInfo.firstName}
							${supervisorInfo.lastName}</label>
					</div>
					<div class="col-sm-3"></div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-3">
						<label class="col-form-label">${supervisorInfo.districtName}</label>
					</div>
					<div class="col-sm-3"></div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-3">
						<label class="col-form-label">${supervisorInfo.schoolName}</label>
					</div>
					<div class="col-sm-3"></div>
				</div>
