...
<c:if
	...
	<div class="form-group row">
		...
		<div class="col-sm-3">
			...
			<label id="outOfStateWaiver" class="col-form-label  font-weight-bold"
...
<c:if
	...
	<c:if test="${(not empty noPractitionerFound and !noPractitionerFound) or candidateEnrollment.practitioner.displaySupervisorInfo }">
		...
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<label class="col-form-label">${candidateEnrollment.practitioner.firstName}
					${candidateEnrollment.practitioner.lastName}</label>
			</div>
			<div class="col-sm-3"></div>
		</div>
